...
use App\Services\AiAgent\Infrastructure\ChatVeBookingService;
...
final class BookTicketTool implements ToolInterface, ToolMissingFieldsChecker
{
    public function __construct(
        ...
        private readonly ChatVeBookingService $chatVeBooking,
    ) {}
    ...
    private function executeRealBook(int $khachHangId, array $book): array
    {
        ...
        try {
            $ve = $this->chatVeBooking->bookForAuthenticatedKhachHang($khachHangId, [
