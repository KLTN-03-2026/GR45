...
class YeuCauRutTienRejectedEvent implements ShouldBroadcastNow
{
    ...
    {
        return 'yeu_cau_rut_tien.rejected';
    }
    ...
    public function broadcastWith()
    {
        return [
            ...
            'message' => 'Yêu cầu rút tiền ' . $this->giaoDich->transaction_code . ' số tiền ' . number_format($this->giaoDich->so_tien, 0, ',', '.') . ' VNĐ đã bị từ chối và hoàn tiền vào ví.',
        ];
    }
}
