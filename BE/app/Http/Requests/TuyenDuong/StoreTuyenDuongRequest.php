...
class StoreTuyenDuongRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'ten_tuyen_duong' => 'required|string|max:255',
            'diem_bat_dau' => 'required|string|max:255',
            ...
            'tram_dungs' => 'required|array|min:2',
            'tram_dungs.*.ten_tram' => 'required|string|max:255',
            'tram_dungs.*.dia_chi' => 'required|string|max:255',
            'tram_dungs.*.loai_tram' => 'required|in:don,tra,ca_hai',
            'tram_dungs.*.thu_tu' => 'required|integer|min:1',
    ...
    public function messages(): array
    {
        return [
            ...
            'tram_dungs.*.ten_tram.required' => 'Tên trạm không được để trống.',
            'tram_dungs.*.dia_chi.required' => 'Địa chỉ trạm không được để trống.',
            'tram_dungs.*.loai_tram.required' => 'Loại trạm không được để trống.',
            'tram_dungs.*.loai_tram.in' => 'Loại trạm phải là: don, tra, ca_hai.',
            'tram_dungs.*.thu_tu.required' => 'Thứ tự trạm không được để trống.',
