...
class StoreChuyenXeRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'id_tuyen_duong' => 'required|integer|exists:tuyen_duongs,id',
            'id_xe' => 'nullable|integer|exists:xes,id',
            'id_tai_xe' => 'nullable|integer|exists:tai_xes,id',
